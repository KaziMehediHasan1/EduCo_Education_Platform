  ...
  return (
    <div>
      <CommonHeader
        ...
        subTitle=" Welcome to our UI/UX Design course! This comprehensive program will
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-[20px] sm:gap-[35px] my-[20px] sm:my-[35px] p-3">
          <div className="bg-white p-7 sm:p-10 rounded-[8px]">
            <div className="space-y-4 sm:space-y-8">
              <h1 className="text-[1.8rem] sm:text-[3rem] leading-[30%] font-semibold text-end">
                01
              </h1>
              <p className="text-[18px] sm:text-2xl leading-[150%] text-[var(--color-textColor)] font-medium">
